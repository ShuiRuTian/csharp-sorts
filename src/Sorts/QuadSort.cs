...
/// <summary>QuadSort — stable bottom-up adaptive branchless merge sort. The kernel
/// (the SortSpan implementation) lands in a later task; until then every Sort
/// overload that reaches the kernel throws NotImplementedException.</summary>
