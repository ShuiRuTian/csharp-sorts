...
public class IpnsortTests : SortContractTests<int>
{
    protected override void Sort(int[] array) => Sorts.Ipnsort.Sort(array);
...
public class IpnsortPairTests : SortContractTests<Pair>
{
    protected override void Sort(Pair[] array) => Sorts.Ipnsort.Sort(array);
...
public class IpnsortDoubleTests : SortContractTests<double>
{
    protected override void Sort(double[] array) => Sorts.Ipnsort.Sort(array);
...
public class IpnsortStringTests : SortContractTests<string>
{
    protected override void Sort(string[] array) => Sorts.Ipnsort.Sort(array);
